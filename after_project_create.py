...
If your starter config needs to create any data in shotgun_repos or do any other
...
* sg -         A shotgun_repos connection
* project_id - The shotgun_repos project id that is being setup
